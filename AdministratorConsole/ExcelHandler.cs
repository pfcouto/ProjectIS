...
namespace AdministratorConsole
{
    class ExcelHandler
    {
        public static void OutputToExcel(string filePath,List<Transaction> transactions)
        {
            try
            {
                ...
                excelWorkbook.SaveAs(filePath, AccessMode: Excel.XlSaveAsAccessMode.xlExclusive);
